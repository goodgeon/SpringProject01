		...
		<div class="container-login100" id = "intro">
			<div id = "loginForm" class="wrap-login100 p-t-30 p-b-50">
				...
				<div class="login100-form p-b-33 p-t-5">
					...
					<div class="container-login100-form-btn m-t-32">
						<button id = "loginBt" class="login100-form-btn">
							Login
						</button>
						<button id = "join" class="login100-form-btn ml-4">
							Join
						</button>
					</div>
				</div>
			...
			<div id = "joinForm" class="wrap-join100 p-t-30 p-b-50">
				...
				<form action = "insertUser" method = "POST" class="login100-form p-b-33 p-t-5">
					...
					<div class="container-login100-form-btn m-t-32">
						<button type = "button" id = "backBt" class="login100-form-btn ml-4">
							Back
						</button>
						<button id = "submitJoinBt" class="login100-form-btn ml-4">
							Join
						</button>
					</div>
				</form>

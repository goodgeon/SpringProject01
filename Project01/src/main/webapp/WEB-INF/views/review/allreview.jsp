    ...
    <div class="container-fluid" style = "text-align : center;">
      ...
      <nav id="nav-menu-container" style = "display : inline-block;">
        <ul class="nav-menu">
          ...
          <li class="menu-active"><a href="/myapp/review/allreview">전체 리뷰 목록</a></li>
    ...
    <div class="movieList-container wow fadeInUp">
   		<div id= "readmovie-row" class = "row">
 				...
 				<table id = "movieInfo" class = "col-lg-7 myreview">
 					<tr>
 						<td rowspan="4" class = "listimgtd"><a href = "/myapp/movie/read?title=${review.moviename}"><img src = "${review.movielink}"></a></td>
 						<th>영화제목</th><td><a href = "/myapp/movie/read?title=${review.moviename}">${review.moviename }</a></td>
 					</tr>
 					<tr>
 						<th>작성자</th>
